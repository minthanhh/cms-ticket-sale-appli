...
const EventPakages = () => {
        ...
        },
        {
            ...
            render(value, record, index) {
                return record.usageStatus === 'notUsedYet' ? (
                    <>
                        <BsThreeDotsVertical size={24} className="cursor-pointer" onClick={() => setTooltip((v) => !v)} />
                        {toggleTooltip ? (
    ...
    useEffect(() => {
        const eventPackage = listTicketPackage.filter((i) => i.ticketPackageName === 'Gói sự kiện')
